...
class TestPipe(unittest.TestCase):
  ...
  def test_add_method_star(self):
    data_1 = (1, 2), (3, 4), (5, 6)
    def filter_1_1(a):
      # print('filter_1_1', a, a[0] > a[1])
      return 2 * a[0] > a[1]
    def filter_1_2(a, b):
      # print('filter_1_2', a, b, 2 * a > b)
      return 2 * a > b
    ...
    print()
    print('function', 'func_after_iter')
    ...
    print()
    print('function', 'extra_input_last')
    ...
    print()
    print('function', 'extra_input_first')
    ...
    print()
    print('function', 'extra_input_middle')
